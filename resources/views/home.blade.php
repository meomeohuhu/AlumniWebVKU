...
<div class="home-content">
    ...
    <section class="banner-section">
        ...
        <h1>Chào mừng đến với Mạng lưới Cựu sinh viên</h1>
        <p>Trang chủ - thông tin tổng quan về mạng lưới.</p>
    </div>
</div>
...
<footer>
    ...
    <div class="footer-section footer-info">
        <p><strong>Mạng lưới Cựu Sinh Viên <br>Trường Đại học Công Nghệ Thông Tin Và Truyền Thông Việt Hàn</strong></p>
